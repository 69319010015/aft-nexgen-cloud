      ...
      >
        ...
        <div className="mb-5">
          ...
          <div className="flex items-center gap-3 ml-1">
            ...
            <div className="flex gap-2">
              <button onClick={() => setDraftSize("small")} className={pillClass(draftSize === "small")}>
                เล็ก
              </button>
              <button onClick={() => setDraftSize("medium")} className={pillClass(draftSize === "medium")}>
                กลาง
              </button>
              <button onClick={() => setDraftSize("large")} className={pillClass(draftSize === "large")}>
                ใหญ่
              </button>
            </div>
          </div>
