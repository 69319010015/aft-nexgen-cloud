  ...
  return (
    <ClientLayout>
      <div className="mx-auto max-w-7xl p-4 md:p-8 space-y-12">
        ...
        {/* 👨‍🏫 Teacher Dashboard */}
        {isTeacher && (
          <section id="section-teacher" className="scroll-mt-4 border-t border-yellow-500/30 pt-8">
            <SectionTitle icon="🧑‍🏫" title="Teacher Dashboard" subtitle="แผงควบคุมระบบ — Edit/Manage projects" />
            <TeacherDashboard />
          </section>
        )}
